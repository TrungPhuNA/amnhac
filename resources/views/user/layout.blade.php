    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="{{ \Request::route()->getName() == 'user.list.tour_wishlist' ? 'active' : '' }}"><a href="{{ route('user.list.tour_wishlist') }}">Sản phẩm quan tâm</a></li>
                <li class="{{ \Request::route()->getName() == 'user.list.tour' ? 'active' : '' }}"><a href="{{ route('user.list.tour') }}">Sản phẩm bán chạy</a></li>
