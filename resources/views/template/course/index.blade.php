...
@section('content')
    ...
    <section>
        <div class="tp_container">
            <div class="tour_list course_list">
                ...
                <div class="width-100 flex" style="flex-wrap: wrap;">
                    @for($i = 1; $i <= 10 ; $i ++)
                        <div class="tour_item course_item">
                            <a href="{{ route('get.course.detail') }}" class="tour_item_img">
                                <img src="{{ $arrayImg[rand(0,3)] }}" alt="">
                            </a>
                            <h3 class="tour_item_name" style="border-bottom: 1px solid #dedede;padding: 10px 0"><a href="">Hướng dẫn kiếm tiền Youtobe</a></h3>
