...
(this, function() {
   ...
   */
   var sheet = (function() {
    ...
    //var el = document.querySelector('style[data-fotorama-style]');
...
function getDataFromHtml ($el) {
	...
	function getDataFromImg ($img, imgData, checkVideo) {
		...
		getDimensions($img, $child, $.extend(imgData, {
			...
			alt: imgData.alt || _imgAlt,
			title: imgData.title || _imgTitle,
			srcset: imgData.imgSrcset || _imgSrcset
		}));
	}
...
function touch ($el, options) {
	...
	function onStart (e) {
		...
		if (touchEnabledFLAG || tail.flow || (e.touches && e.touches.length > 1) || e.which > 1 || (lastEvent && lastEvent.type !== e.type && preventEvent) || (targetIsSelectFLAG = options.select && $target.is(options.select, el))) {
...
jQuery.Fotorama = function ($fotorama, opts) {
	...
	$style = $('<style data-fotorama-style></style>'),
...
function thumbsDraw (pos, loadFLAG) {
    ...
    if (thisData.l + thisData.w < leftLimit || thisData.l > rightLimit || callFit(thisData.$img, specialMeasures, method, position, smartfitPx, smartfitThreshold)) {
      return;
    }
